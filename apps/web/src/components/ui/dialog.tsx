...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        "data-open:animate-in data-closed:animate-out data-closed:fade-out-0 data-open:fade-in-0 bg-black/40 duration-100 supports-backdrop-filter:backdrop-blur-md fixed inset-0 isolate z-50",
        className,
      )}
      {...props}
    />
